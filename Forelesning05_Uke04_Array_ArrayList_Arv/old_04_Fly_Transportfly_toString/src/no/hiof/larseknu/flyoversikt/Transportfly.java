...
public class Transportfly extends Fly {
    ...
    /**
     * Vi overrider metoden toString(), som kommer fra Object-klassen
     * Dette gjør at vi får en "standardutskrift" når vi printer ut objektet
     * Benytter her også data fra super-klassen Fly
     */
    @Override
    public String toString() {
        return "Transportfly modell: " + super.getModell() + " med " + super.getSeter() + " seter og maks last på " + maksLast + " kubikkmeter.";
    }
}
